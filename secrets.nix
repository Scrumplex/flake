...
in {
  ...
  "nix/modules/extensions/traefik/hetzner-api-token.env.age".publicKeys = scrumplex ++ eclipse ++ galileo ++ universe;
  ...
  "nix/modules/machines/galileo/frigate/frigate.env.age".publicKeys = galileo ++ scrumplex;
  "nix/modules/machines/galileo/frigate/mqtt-password.age".publicKeys = galileo ++ scrumplex;
  "nix/modules/machines/galileo/home-assistant/secrets.yaml.age".publicKeys = galileo ++ scrumplex;
  "nix/modules/machines/galileo/home-assistant/mqtt-password.age".publicKeys = galileo ++ scrumplex;
  ...
  "nix/modules/machines/universe/lgtm/alloy/alloy-htaccess.age".publicKeys = universe ++ scrumplex;
