{
  flake.modules.nixos."base" = {
    ...
    inherit (lib) types mapAttrs mkIf mkDefault mkMerge literalExpression mkOption;
  ...
  in {
    ...
    config = mkMerge [
      {
        virtualisation.oci-containers.externalImages.imagesFile = mkDefault ../../../values.yaml;
      }
      (mkIf (cfg.imagesFile != null) {
